...
type RemoteSignerInformer interface {
	...
	ForwardLocalCommitment(ctx context.Context, commitTx *wire.MsgTx,
	...
	ForwardMuSig2Info(ctx context.Context, muSig2SessionId []byte,
	...
	ForwardFundingInfo(ctx context.Context, fundingPoint *wire.OutPoint,
