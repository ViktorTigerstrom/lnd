...
func (ms *mockSCStream) RecvMsg(msg any) error {
	return nil
}

func (ms *mockSCStream) SendHeader(metadata.MD) error {
	return nil
}

func (ms *mockSCStream) SendMsg(m any) error {
	return nil
}
func (ms *mockSCStream) SetHeader(metadata.MD) error {
	return nil
}
