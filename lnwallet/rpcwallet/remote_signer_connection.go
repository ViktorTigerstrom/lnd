...
func (r *OutboundConnection) ForwardLocalCommitment(_ context.Context,
...
//
// Note: this is part of the RemoteSignerInformer interface.
func (s *OutboundConnection) ForwardMuSig2Info(_ context.Context, _ []byte,
	_ *wire.MsgTx, _ *input.SignDescriptor) error {
...
//
// Note: this is part of the RemoteSignerInformer interface.
func (r *OutboundConnection) ForwardFundingInfo(_ context.Context,
	_ *wire.OutPoint, _ *channeldb.ChannelConfig,
	_ *channeldb.ChannelConfig, _ channeldb.ChannelType, _ bool) error {
