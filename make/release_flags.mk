...
RELEASE_TAGS = autopilotrpc signrpc walletrpc chainrpc invoicesrpc watchtowerrpc neutrinorpc remotesignerrpc monitoring peersrpc kvdb_postgres kvdb_etcd kvdb_sqlite

LND_SIGNER_TAGS = signrpc walletrpc remotesignerrpc monitoring kvdb_postgres kvdb_etcd kvdb_sqlite

WASM_RELEASE_TAGS = autopilotrpc signrpc walletrpc remotesignerrpc chainrpc invoicesrpc watchtowerrpc neutrinorpc monitoring peersrpc
