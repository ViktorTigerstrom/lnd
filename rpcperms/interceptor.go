...
const (
	...
	// rpc calls to connect the remote signer are allowed at this state.
	allowRemoteSigner
...
var (
	...
	// when the when we are waiting for the remote signer to connect, i.e.
	// in the allowRemoteSigner state.
...
func (r *InterceptorChain) checkRPCState(srv interface{},
	...
	case allowRemoteSigner:
		...
		// whitelisted, and if not, return an error.
