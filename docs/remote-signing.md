...
binary called `lndsigner`. This is a simplified version of `lnd` designed
specifically for use as a "remote signer" in remote signing setups. It provides
...
If you use the `lndsigner` binary as the remote signer instead, it is
