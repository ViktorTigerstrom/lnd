...
// RemoteSignerConnection is an interface that mimics a subset of the rpcwallet
// RemoteSignerConnection interface to avoid circular dependencies.
...
func (w *WalletKit) SignCoordinatorStreams(
	...
	signer := w.cfg.RemoteSignerConnection
