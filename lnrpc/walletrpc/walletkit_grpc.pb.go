...
type WalletKitClient interface {
	...
	// SignCoordinatorStreams dispatches a bi-directional streaming RPC which
	// allows a remote signer to connect to lnd, and to then proceed to remotely
	// feed the lnd with signatures required during lnd's execution.
