...
type SignCoordinatorRequest struct {
	...
	//	*SignCoordinatorRequest_MetadataRequest
...
func (x *SignCoordinatorRequest) GetMetadataRequest() *MetadataRequest {
	if x, ok := x.GetSignRequestType().(*SignCoordinatorRequest_MetadataRequest); ok {
...
type SignCoordinatorRequest_MetadataRequest struct {
	// Forwards metadata to the remote signer.
	MetadataRequest *MetadataRequest `protobuf:"bytes,12,opt,name=metadata_request,json=metadataRequest,proto3,oneof"`
}
...
func (*SignCoordinatorRequest_MetadataRequest) isSignCoordinatorRequest_SignRequestType() {}
...
type SignCoordinatorResponse struct {
	...
	//	*SignCoordinatorResponse_MetadataReceived
...
func (x *SignCoordinatorResponse) GetMetadataReceived() bool {
	if x, ok := x.GetSignResponseType().(*SignCoordinatorResponse_MetadataReceived); ok {
		return x.MetadataReceived
	}
	return false
}
...
type SignCoordinatorResponse_MetadataReceived struct {
	// The remote signer's corresponding response to a Local Commitment Info
	// request, to signal that the remote signer has received the local
	// commitment info.
	MetadataReceived bool `protobuf:"varint,13,opt,name=metadata_received,json=metadataReceived,proto3,oneof"`
}
...
func (*SignCoordinatorResponse_MetadataReceived) isSignCoordinatorResponse_SignResponseType() {}
...
type MetadataRequest struct {
	...
	// The forwarded metadata to the remote signer can only be of certain types.
	//
	// Types that are assignable to MetadataType:
	//
	//	*MetadataRequest_LocalCommitmentInfo
	//	*MetadataRequest_FundingInfo
	//	*MetadataRequest_Accounts
	MetadataType isMetadataRequest_MetadataType `protobuf_oneof:"metadata_type"`
}
...
func (m *MetadataRequest) GetMetadataType() isMetadataRequest_MetadataType {
	if m != nil {
...
func (x *MetadataRequest) GetLocalCommitmentInfo() *SignPsbtRequest {
	if x, ok := x.GetMetadataType().(*MetadataRequest_LocalCommitmentInfo); ok {
		return x.LocalCommitmentInfo
	}
	return nil
}

func (x *MetadataRequest) GetFundingInfo() *FundingInfo {
	if x, ok := x.GetMetadataType().(*MetadataRequest_FundingInfo); ok {
		return x.FundingInfo
	}
	return nil
}

func (x *MetadataRequest) GetAccounts() *ListAccountsResponse {
	if x, ok := x.GetMetadataType().(*MetadataRequest_Accounts); ok {
		return x.Accounts
	}
	return nil
}

type isMetadataRequest_MetadataType interface {
	isMetadataRequest_MetadataType()
}

type MetadataRequest_LocalCommitmentInfo struct {
	// Informs the remote signer of the current local commitment transaction.
	// Note: This is not a request to the remote signer to sign the local
	// commitment, it is strictly only used for informing remote signer about
	// the latest local commitment transaction.
	LocalCommitmentInfo *SignPsbtRequest `protobuf:"bytes,1,opt,name=local_commitment_info,json=localCommitmentInfo,proto3,oneof"`
}

type MetadataRequest_FundingInfo struct {
	// Informs the remote signer of information regarding a new channel when
	// channel has been funded and has a valid funding outpoint.
	FundingInfo *FundingInfo `protobuf:"bytes,2,opt,name=funding_info,json=fundingInfo,proto3,oneof"`
}

type MetadataRequest_Accounts struct {
	// Informs the remote signer of the accounts the watch-only uses.
	Accounts *ListAccountsResponse `protobuf:"bytes,3,opt,name=accounts,proto3,oneof"`
}

func (*MetadataRequest_LocalCommitmentInfo) isMetadataRequest_MetadataType() {}

func (*MetadataRequest_FundingInfo) isMetadataRequest_MetadataType() {}

func (*MetadataRequest_Accounts) isMetadataRequest_MetadataType() {}
...
type FundingInfo struct {
	...
	// The funding outpoint for the channel.
	FundingOutpoint *lnrpc.OutPoint `protobuf:"bytes,1,opt,name=funding_outpoint,json=fundingOutpoint,proto3" json:"funding_outpoint,omitempty"`
	// The channel type of the channel.
	ChannelType uint64 `protobuf:"varint,2,opt,name=channel_type,json=channelType,proto3" json:"channel_type,omitempty"`
	// Signals if the local node is the initiator of the channel.
	IsLocalInitiator bool `protobuf:"varint,3,opt,name=is_local_initiator,json=isLocalInitiator,proto3" json:"is_local_initiator,omitempty"`
	// The local channel config of the channel.
	LocalChannelConfig *lnrpc.ChannelConfig `protobuf:"bytes,4,opt,name=local_channel_config,json=localChannelConfig,proto3" json:"local_channel_config,omitempty"`
	// The remote channel config of the channel.
	RemoteChannelConfig *lnrpc.ChannelConfig `protobuf:"bytes,5,opt,name=remote_channel_config,json=remoteChannelConfig,proto3" json:"remote_channel_config,omitempty"`
}
...
func (x *FundingInfo) GetFundingOutpoint() *lnrpc.OutPoint {
	if x != nil {
		return x.FundingOutpoint
	}
	return nil
}

func (x *FundingInfo) GetChannelType() uint64 {
	if x != nil {
...
func (x *FundingInfo) GetIsLocalInitiator() bool {
	if x != nil {
		return x.IsLocalInitiator
	}
	return false
}

func (x *FundingInfo) GetLocalChannelConfig() *lnrpc.ChannelConfig {
	if x != nil {
		return x.LocalChannelConfig
	}
	return nil
}

func (x *FundingInfo) GetRemoteChannelConfig() *lnrpc.ChannelConfig {
	if x != nil {
		return x.RemoteChannelConfig
	}
	return nil
}
...
type RegistrationComplete struct {
	...
	// remote signer.
	RegistrationInfo string `protobuf:"bytes,2,opt,name=registration_info,json=registrationInfo,proto3" json:"registration_info,omitempty"`
	// Wallet info contains information about the wallet that the remote signer
	// has connected to.
	//
	// Types that are assignable to WalletInfo:
	//
	//	*RegistrationComplete_Accounts
	WalletInfo isRegistrationComplete_WalletInfo `protobuf_oneof:"wallet_info"`
}
...
func (m *RegistrationComplete) GetWalletInfo() isRegistrationComplete_WalletInfo {
	if m != nil {
		return m.WalletInfo
	}
	return nil
...
func (x *RegistrationComplete) GetAccounts() *ListAccountsResponse {
	if x, ok := x.GetWalletInfo().(*RegistrationComplete_Accounts); ok {
		return x.Accounts
	}
	return nil
}

type isRegistrationComplete_WalletInfo interface {
	isRegistrationComplete_WalletInfo()
}

type RegistrationComplete_Accounts struct {
	// Accounts contains the accounts that the watch-only node uses in the
	// wallet.
	Accounts *ListAccountsResponse `protobuf:"bytes,3,opt,name=accounts,proto3,oneof"`
}

func (*RegistrationComplete_Accounts) isRegistrationComplete_WalletInfo() {}
...
func (x *ListLeasesResponse) Reset() {
	*x = ListLeasesResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_walletrpc_walletkit_proto_msgTypes[68]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListLeasesResponse) Descriptor() ([]byte, []int) {
	return file_walletrpc_walletkit_proto_rawDescGZIP(), []int{68}
}
...
func (*ListSweepsResponse_TransactionIDs) Descriptor() ([]byte, []int) {
	return file_walletrpc_walletkit_proto_rawDescGZIP(), []int{55, 0}
}
...
var file_walletrpc_walletkit_proto_rawDesc = []byte{
	...
	0x2f, 0x73, 0x69, 0x67, 0x6e, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xac, 0x07,
	...
	,
	...
	0x52, 0x15, 0x6d, 0x75, 0x53, 0x69, 0x67, 0x32, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x6f, 0x0a, 0x20, 0x6d, 0x75, 0x5f, 0x73, 0x69,
	0x67, 0x32, 0x5f, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x5f, 0x6e, 0x6f, 0x6e, 0x63,
	0x65, 0x73, 0x5f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x25, 0x2e, 0x73, 0x69, 0x67, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x4d, 0x75, 0x53, 0x69,
	...
	,
	...
	,
	...
	0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x29, 0x0a, 0x10, 0x75, 0x6e, 0x63, 0x6f, 0x6e,
	0x66, 0x69, 0x72, 0x6d, 0x65, 0x64, 0x5f, 0x6f, 0x6e, 0x6c, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x0f, 0x75, 0x6e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d, 0x65, 0x64, 0x4f, 0x6e,
	0x6c, 0x79, 0x22, 0x38, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x55, 0x6e, 0x73, 0x70, 0x65, 0x6e,
	...
	0x2e, 0x55, 0x74, 0x78, 0x6f, 0x52, 0x05, 0x75, 0x74, 0x78, 0x6f, 0x73, 0x22, 0x80, 0x01, 0x0a,
	0x12, 0x4c, 0x65, 0x61, 0x73, 0x65, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x52, 0x65, 0x71, 0x75,
	...
	0x65, 0x63, 0x6f, 0x6e, 0x64, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x11, 0x65, 0x78,
	0x70, 0x69, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x73, 0x22,
	0x35, 0x0a, 0x13, 0x4c, 0x65, 0x61, 0x73, 0x65, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x52, 0x65,
	...
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x53, 0x0a, 0x14, 0x52, 0x65, 0x6c, 0x65, 0x61, 0x73,
	0x65, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e,
	...
	,
	...
	0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x22, 0x22, 0x0a, 0x0c,
	0x41, 0x64, 0x64, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x12, 0x0a, 0x04,
	0x61, 0x64, 0x64, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x61, 0x64, 0x64, 0x72,
	0x22, 0xe2, 0x02, 0x0a, 0x07, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x12, 0x0a, 0x04,
	...
	0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x54, 0x79, 0x70, 0x65, 0x12, 0x2e, 0x0a, 0x13, 0x65,
	0x78, 0x74, 0x65, 0x6e, 0x64, 0x65, 0x64, 0x5f, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x5f, 0x6b,
	0x65, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x64,
	...
	,
	...
	0x69, 0x6f, 0x6e, 0x50, 0x61, 0x74, 0x68, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x75, 0x62, 0x6c, 0x69,
	0x63, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x09, 0x70, 0x75, 0x62,
	0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x22, 0xc8, 0x01, 0x0a, 0x14, 0x41, 0x63, 0x63, 0x6f, 0x75,
	...
	0x72, 0x65, 0x73, 0x73, 0x54, 0x79, 0x70, 0x65, 0x22, 0x31, 0x0a, 0x17, 0x49, 0x6d, 0x70, 0x6f,
	0x72, 0x74, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xa9, 0x02, 0x0a, 0x16,
	0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x54, 0x61, 0x70, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2e, 0x0a, 0x13, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e,
	...
	,
	...
	0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x22, 0x2c, 0x0a, 0x13, 0x53, 0x65, 0x6e, 0x64, 0x4f,
	...
	0x52, 0x0a, 0x63, 0x6f, 0x6e, 0x66, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x22, 0x6a, 0x0a, 0x13,
	...
	0x77, 0x12, 0x35, 0x0a, 0x18, 0x6d, 0x69, 0x6e, 0x5f, 0x72, 0x65, 0x6c, 0x61, 0x79, 0x5f, 0x66,
	0x65, 0x65, 0x5f, 0x73, 0x61, 0x74, 0x5f, 0x70, 0x65, 0x72, 0x5f, 0x6b, 0x77, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x13, 0x6d, 0x69, 0x6e, 0x52, 0x65, 0x6c, 0x61, 0x79, 0x46, 0x65, 0x65,
	0x53, 0x61, 0x74, 0x50, 0x65, 0x72, 0x4b, 0x77, 0x22, 0xe7, 0x04, 0x0a, 0x0c, 0x50, 0x65, 0x6e,
	0x64, 0x69, 0x6e, 0x67, 0x53, 0x77, 0x65, 0x65, 0x70, 0x12, 0x2b, 0x0a, 0x08, 0x6f, 0x75, 0x74,
	...
	,
	...
	,
	...
	0x65, 0x70, 0x73, 0x22, 0xf8, 0x01, 0x0a, 0x0e, 0x42, 0x75, 0x6d, 0x70, 0x46, 0x65, 0x65, 0x52,
	...
	,
	...
	,
	...
	0x6e, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x48, 0x00, 0x52, 0x12, 0x74, 0x72, 0x61, 0x6e,
	0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x12, 0x57,
	0x0a, 0x0f, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64,
	0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74,
	...
	0x6f, 0x6e, 0x49, 0x44, 0x73, 0x48, 0x00, 0x52, 0x0e, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x73, 0x1a, 0x39, 0x0a, 0x0e, 0x54, 0x72, 0x61, 0x6e, 0x73,
	0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x44, 0x73, 0x12, 0x27, 0x0a, 0x0f, 0x74, 0x72, 0x61,
	...
	0x64, 0x73, 0x42, 0x08, 0x0a, 0x06, 0x73, 0x77, 0x65, 0x65, 0x70, 0x73, 0x22, 0x61, 0x0a, 0x17,
	...
	0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x74, 0x78, 0x69, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x6c,
	...
	0x32, 0x0a, 0x18, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x73,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x22, 0xaa, 0x04, 0x0a, 0x0f, 0x46, 0x75, 0x6e, 0x64, 0x50, 0x73, 0x62, 0x74,
	...
	0x1e, 0x0a, 0x0a, 0x73, 0x61, 0x74, 0x5f, 0x70, 0x65, 0x72, 0x5f, 0x6b, 0x77, 0x18, 0x0b, 0x20,
	0x01, 0x28, 0x04, 0x48, 0x01, 0x52, 0x08, 0x73, 0x61, 0x74, 0x50, 0x65, 0x72, 0x4b, 0x77, 0x12,
	...
	0x53, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x12, 0x22, 0x0a, 0x0d, 0x6d, 0x61, 0x78, 0x5f,
	0x66, 0x65, 0x65, 0x5f, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x01, 0x52,
	0x0b, 0x6d, 0x61, 0x78, 0x46, 0x65, 0x65, 0x52, 0x61, 0x74, 0x69, 0x6f, 0x42, 0x0a, 0x0a, 0x08,
	...
	0x50, 0x32, 0x54, 0x52, 0x10, 0x01, 0x32, 0xbb, 0x12, 0x0a, 0x09, 0x57, 0x61, 0x6c, 0x6c, 0x65,
	...
	0x63, 0x0a, 0x16, 0x53, 0x69, 0x67, 0x6e, 0x43, 0x6f, 0x6f, 0x72, 0x64, 0x69, 0x6e, 0x61, 0x74,
	0x6f, 0x72, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x73, 0x12, 0x22, 0x2e, 0x77, 0x61, 0x6c, 0x6c,
	0x65, 0x74, 0x72, 0x70, 0x63, 0x2e, 0x53, 0x69, 0x67, 0x6e, 0x43, 0x6f, 0x6f, 0x72, 0x64, 0x69,
	0x6e, 0x61, 0x74, 0x6f, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x1a, 0x21, 0x2e,
	0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x72, 0x70, 0x63, 0x2e, 0x53, 0x69, 0x67, 0x6e, 0x43, 0x6f,
...
var file_walletrpc_walletkit_proto_goTypes = []interface{}{
	...
	(*MetadataRequest)(nil),                   // 5: walletrpc.MetadataRequest
	(*FundingInfo)(nil),                       // 6: walletrpc.FundingInfo
	(*SignerError)(nil),                       // 7: walletrpc.SignerError
	(*SignerRegistration)(nil),                // 8: walletrpc.SignerRegistration
	(*RegistrationResponse)(nil),              // 9: walletrpc.RegistrationResponse
	(*RegistrationComplete)(nil),              // 10: walletrpc.RegistrationComplete
	(*ListUnspentRequest)(nil),                // 11: walletrpc.ListUnspentRequest
	(*ListUnspentResponse)(nil),               // 12: walletrpc.ListUnspentResponse
	(*LeaseOutputRequest)(nil),                // 13: walletrpc.LeaseOutputRequest
	(*LeaseOutputResponse)(nil),               // 14: walletrpc.LeaseOutputResponse
	(*ReleaseOutputRequest)(nil),              // 15: walletrpc.ReleaseOutputRequest
	(*ReleaseOutputResponse)(nil),             // 16: walletrpc.ReleaseOutputResponse
	(*KeyReq)(nil),                            // 17: walletrpc.KeyReq
	(*AddrRequest)(nil),                       // 18: walletrpc.AddrRequest
	(*AddrResponse)(nil),                      // 19: walletrpc.AddrResponse
	(*Account)(nil),                           // 20: walletrpc.Account
	(*AddressProperty)(nil),                   // 21: walletrpc.AddressProperty
	(*AccountWithAddresses)(nil),              // 22: walletrpc.AccountWithAddresses
	(*ListAccountsRequest)(nil),               // 23: walletrpc.ListAccountsRequest
	(*ListAccountsResponse)(nil),              // 24: walletrpc.ListAccountsResponse
	(*RequiredReserveRequest)(nil),            // 25: walletrpc.RequiredReserveRequest
	(*RequiredReserveResponse)(nil),           // 26: walletrpc.RequiredReserveResponse
	(*ListAddressesRequest)(nil),              // 27: walletrpc.ListAddressesRequest
	(*ListAddressesResponse)(nil),             // 28: walletrpc.ListAddressesResponse
	(*GetTransactionRequest)(nil),             // 29: walletrpc.GetTransactionRequest
	(*SignMessageWithAddrRequest)(nil),        // 30: walletrpc.SignMessageWithAddrRequest
	(*SignMessageWithAddrResponse)(nil),       // 31: walletrpc.SignMessageWithAddrResponse
	(*VerifyMessageWithAddrRequest)(nil),      // 32: walletrpc.VerifyMessageWithAddrRequest
	(*VerifyMessageWithAddrResponse)(nil),     // 33: walletrpc.VerifyMessageWithAddrResponse
	(*ImportAccountRequest)(nil),              // 34: walletrpc.ImportAccountRequest
	(*ImportAccountResponse)(nil),             // 35: walletrpc.ImportAccountResponse
	(*ImportPublicKeyRequest)(nil),            // 36: walletrpc.ImportPublicKeyRequest
	(*ImportPublicKeyResponse)(nil),           // 37: walletrpc.ImportPublicKeyResponse
	(*ImportTapscriptRequest)(nil),            // 38: walletrpc.ImportTapscriptRequest
	(*TapscriptFullTree)(nil),                 // 39: walletrpc.TapscriptFullTree
	(*TapLeaf)(nil),                           // 40: walletrpc.TapLeaf
	(*TapscriptPartialReveal)(nil),            // 41: walletrpc.TapscriptPartialReveal
	(*ImportTapscriptResponse)(nil),           // 42: walletrpc.ImportTapscriptResponse
	(*Transaction)(nil),                       // 43: walletrpc.Transaction
	(*PublishResponse)(nil),                   // 44: walletrpc.PublishResponse
	(*RemoveTransactionResponse)(nil),         // 45: walletrpc.RemoveTransactionResponse
	(*SendOutputsRequest)(nil),                // 46: walletrpc.SendOutputsRequest
	(*SendOutputsResponse)(nil),               // 47: walletrpc.SendOutputsResponse
	(*EstimateFeeRequest)(nil),                // 48: walletrpc.EstimateFeeRequest
	(*EstimateFeeResponse)(nil),               // 49: walletrpc.EstimateFeeResponse
	(*PendingSweep)(nil),                      // 50: walletrpc.PendingSweep
	(*PendingSweepsRequest)(nil),              // 51: walletrpc.PendingSweepsRequest
	(*PendingSweepsResponse)(nil),             // 52: walletrpc.PendingSweepsResponse
	(*BumpFeeRequest)(nil),                    // 53: walletrpc.BumpFeeRequest
	(*BumpFeeResponse)(nil),                   // 54: walletrpc.BumpFeeResponse
	(*BumpForceCloseFeeRequest)(nil),          // 55: walletrpc.BumpForceCloseFeeRequest
	(*BumpForceCloseFeeResponse)(nil),         // 56: walletrpc.BumpForceCloseFeeResponse
	(*ListSweepsRequest)(nil),                 // 57: walletrpc.ListSweepsRequest
	(*ListSweepsResponse)(nil),                // 58: walletrpc.ListSweepsResponse
	(*LabelTransactionRequest)(nil),           // 59: walletrpc.LabelTransactionRequest
	(*LabelTransactionResponse)(nil),          // 60: walletrpc.LabelTransactionResponse
	(*FundPsbtRequest)(nil),                   // 61: walletrpc.FundPsbtRequest
	(*FundPsbtResponse)(nil),                  // 62: walletrpc.FundPsbtResponse
	(*TxTemplate)(nil),                        // 63: walletrpc.TxTemplate
	(*PsbtCoinSelect)(nil),                    // 64: walletrpc.PsbtCoinSelect
	(*UtxoLease)(nil),                         // 65: walletrpc.UtxoLease
	(*SignPsbtRequest)(nil),                   // 66: walletrpc.SignPsbtRequest
	(*SignPsbtResponse)(nil),                  // 67: walletrpc.SignPsbtResponse
	(*FinalizePsbtRequest)(nil),               // 68: walletrpc.FinalizePsbtRequest
	(*FinalizePsbtResponse)(nil),              // 69: walletrpc.FinalizePsbtResponse
	(*ListLeasesRequest)(nil),                 // 70: walletrpc.ListLeasesRequest
	(*ListLeasesResponse)(nil),                // 71: walletrpc.ListLeasesResponse
	...
	(*signrpc.SharedKeyRequest)(nil),             // 74: signrpc.SharedKeyRequest
	(*signrpc.SignMessageReq)(nil),               // 75: signrpc.SignMessageReq
	(*signrpc.MuSig2SessionRequest)(nil),         // 76: signrpc.MuSig2SessionRequest
	(*signrpc.MuSig2RegisterNoncesRequest)(nil),  // 77: signrpc.MuSig2RegisterNoncesRequest
	...
	(*signrpc.MuSig2SignResponse)(nil),           // 85: signrpc.MuSig2SignResponse
	(*signrpc.MuSig2CombineSigResponse)(nil),     // 86: signrpc.MuSig2CombineSigResponse
	(*signrpc.MuSig2CleanupResponse)(nil),        // 87: signrpc.MuSig2CleanupResponse
	(*lnrpc.OutPoint)(nil),                       // 88: lnrpc.OutPoint
	(*lnrpc.ChannelConfig)(nil),                  // 89: lnrpc.ChannelConfig
	(*lnrpc.Utxo)(nil),                           // 90: lnrpc.Utxo
	(*signrpc.TxOut)(nil),                        // 91: signrpc.TxOut
	(lnrpc.CoinSelectionStrategy)(0),             // 92: lnrpc.CoinSelectionStrategy
	(*lnrpc.ChannelPoint)(nil),                   // 93: lnrpc.ChannelPoint
	(*lnrpc.TransactionDetails)(nil),             // 94: lnrpc.TransactionDetails
	(*signrpc.KeyLocator)(nil),                   // 95: signrpc.KeyLocator
	(*signrpc.KeyDescriptor)(nil),                // 96: signrpc.KeyDescriptor
	(*lnrpc.Transaction)(nil),                    // 97: lnrpc.Transaction
}
var file_walletrpc_walletkit_proto_depIdxs = []int32{
	9,  // 0: walletrpc.SignCoordinatorRequest.registration_response:type_name -> walletrpc.RegistrationResponse
	74, // 1: walletrpc.SignCoordinatorRequest.shared_key_request:type_name -> signrpc.SharedKeyRequest
	75, // 2: walletrpc.SignCoordinatorRequest.sign_message_req:type_name -> signrpc.SignMessageReq
	76, // 3: walletrpc.SignCoordinatorRequest.mu_sig2_session_request:type_name -> signrpc.MuSig2SessionRequest
	77, // 4: walletrpc.SignCoordinatorRequest.mu_sig2_register_nonces_request:type_name -> signrpc.MuSig2RegisterNoncesRequest
	78, // 5: walletrpc.SignCoordinatorRequest.mu_sig2_sign_request:type_name -> signrpc.MuSig2SignRequest
	79, // 6: walletrpc.SignCoordinatorRequest.mu_sig2_combine_sig_request:type_name -> signrpc.MuSig2CombineSigRequest
	80, // 7: walletrpc.SignCoordinatorRequest.mu_sig2_cleanup_request:type_name -> signrpc.MuSig2CleanupRequest
	66, // 8: walletrpc.SignCoordinatorRequest.sign_psbt_request:type_name -> walletrpc.SignPsbtRequest
	5,  // 9: walletrpc.SignCoordinatorRequest.metadata_request:type_name -> walletrpc.MetadataRequest
	8,  // 10: walletrpc.SignCoordinatorResponse.signer_registration:type_name -> walletrpc.SignerRegistration
	81, // 11: walletrpc.SignCoordinatorResponse.shared_key_response:type_name -> signrpc.SharedKeyResponse
	82, // 12: walletrpc.SignCoordinatorResponse.sign_message_resp:type_name -> signrpc.SignMessageResp
	83, // 13: walletrpc.SignCoordinatorResponse.mu_sig2_session_response:type_name -> signrpc.MuSig2SessionResponse
	84, // 14: walletrpc.SignCoordinatorResponse.mu_sig2_register_nonces_response:type_name -> signrpc.MuSig2RegisterNoncesResponse
	85, // 15: walletrpc.SignCoordinatorResponse.mu_sig2_sign_response:type_name -> signrpc.MuSig2SignResponse
	86, // 16: walletrpc.SignCoordinatorResponse.mu_sig2_combine_sig_response:type_name -> signrpc.MuSig2CombineSigResponse
	87, // 17: walletrpc.SignCoordinatorResponse.mu_sig2_cleanup_response:type_name -> signrpc.MuSig2CleanupResponse
	67, // 18: walletrpc.SignCoordinatorResponse.sign_psbt_response:type_name -> walletrpc.SignPsbtResponse
	7,  // 19: walletrpc.SignCoordinatorResponse.signer_error:type_name -> walletrpc.SignerError
	66, // 20: walletrpc.MetadataRequest.local_commitment_info:type_name -> walletrpc.SignPsbtRequest
	6,  // 21: walletrpc.MetadataRequest.funding_info:type_name -> walletrpc.FundingInfo
	24, // 22: walletrpc.MetadataRequest.accounts:type_name -> walletrpc.ListAccountsResponse
	88, // 23: walletrpc.FundingInfo.funding_outpoint:type_name -> lnrpc.OutPoint
	89, // 24: walletrpc.FundingInfo.local_channel_config:type_name -> lnrpc.ChannelConfig
	89, // 25: walletrpc.FundingInfo.remote_channel_config:type_name -> lnrpc.ChannelConfig
	10, // 26: walletrpc.RegistrationResponse.registration_complete:type_name -> walletrpc.RegistrationComplete
	24, // 27: walletrpc.RegistrationComplete.accounts:type_name -> walletrpc.ListAccountsResponse
	90, // 28: walletrpc.ListUnspentResponse.utxos:type_name -> lnrpc.Utxo
	88, // 29: walletrpc.LeaseOutputRequest.outpoint:type_name -> lnrpc.OutPoint
	88, // 30: walletrpc.ReleaseOutputRequest.outpoint:type_name -> lnrpc.OutPoint
	0,  // 31: walletrpc.AddrRequest.type:type_name -> walletrpc.AddressType
	0,  // 32: walletrpc.Account.address_type:type_name -> walletrpc.AddressType
	0,  // 33: walletrpc.AccountWithAddresses.address_type:type_name -> walletrpc.AddressType
	21, // 34: walletrpc.AccountWithAddresses.addresses:type_name -> walletrpc.AddressProperty
	0,  // 35: walletrpc.ListAccountsRequest.address_type:type_name -> walletrpc.AddressType
	20, // 36: walletrpc.ListAccountsResponse.accounts:type_name -> walletrpc.Account
	22, // 37: walletrpc.ListAddressesResponse.account_with_addresses:type_name -> walletrpc.AccountWithAddresses
	0,  // 38: walletrpc.ImportAccountRequest.address_type:type_name -> walletrpc.AddressType
	20, // 39: walletrpc.ImportAccountResponse.account:type_name -> walletrpc.Account
	0,  // 40: walletrpc.ImportPublicKeyRequest.address_type:type_name -> walletrpc.AddressType
	39, // 41: walletrpc.ImportTapscriptRequest.full_tree:type_name -> walletrpc.TapscriptFullTree
	41, // 42: walletrpc.ImportTapscriptRequest.partial_reveal:type_name -> walletrpc.TapscriptPartialReveal
	40, // 43: walletrpc.TapscriptFullTree.all_leaves:type_name -> walletrpc.TapLeaf
	40, // 44: walletrpc.TapscriptPartialReveal.revealed_leaf:type_name -> walletrpc.TapLeaf
	91, // 45: walletrpc.SendOutputsRequest.outputs:type_name -> signrpc.TxOut
	92, // 46: walletrpc.SendOutputsRequest.coin_selection_strategy:type_name -> lnrpc.CoinSelectionStrategy
	88, // 47: walletrpc.PendingSweep.outpoint:type_name -> lnrpc.OutPoint
	1,  // 48: walletrpc.PendingSweep.witness_type:type_name -> walletrpc.WitnessType
	50, // 49: walletrpc.PendingSweepsResponse.pending_sweeps:type_name -> walletrpc.PendingSweep
	88, // 50: walletrpc.BumpFeeRequest.outpoint:type_name -> lnrpc.OutPoint
	93, // 51: walletrpc.BumpForceCloseFeeRequest.chan_point:type_name -> lnrpc.ChannelPoint
	94, // 52: walletrpc.ListSweepsResponse.transaction_details:type_name -> lnrpc.TransactionDetails
	72, // 53: walletrpc.ListSweepsResponse.transaction_ids:type_name -> walletrpc.ListSweepsResponse.TransactionIDs
	63, // 54: walletrpc.FundPsbtRequest.raw:type_name -> walletrpc.TxTemplate
	64, // 55: walletrpc.FundPsbtRequest.coin_select:type_name -> walletrpc.PsbtCoinSelect
	2,  // 56: walletrpc.FundPsbtRequest.change_type:type_name -> walletrpc.ChangeAddressType
	92, // 57: walletrpc.FundPsbtRequest.coin_selection_strategy:type_name -> lnrpc.CoinSelectionStrategy
	65, // 58: walletrpc.FundPsbtResponse.locked_utxos:type_name -> walletrpc.UtxoLease
	88, // 59: walletrpc.TxTemplate.inputs:type_name -> lnrpc.OutPoint
	73, // 60: walletrpc.TxTemplate.outputs:type_name -> walletrpc.TxTemplate.OutputsEntry
	88, // 61: walletrpc.UtxoLease.outpoint:type_name -> lnrpc.OutPoint
	65, // 62: walletrpc.ListLeasesResponse.locked_utxos:type_name -> walletrpc.UtxoLease
	11, // 63: walletrpc.WalletKit.ListUnspent:input_type -> walletrpc.ListUnspentRequest
	13, // 64: walletrpc.WalletKit.LeaseOutput:input_type -> walletrpc.LeaseOutputRequest
	15, // 65: walletrpc.WalletKit.ReleaseOutput:input_type -> walletrpc.ReleaseOutputRequest
	70, // 66: walletrpc.WalletKit.ListLeases:input_type -> walletrpc.ListLeasesRequest
	17, // 67: walletrpc.WalletKit.DeriveNextKey:input_type -> walletrpc.KeyReq
	95, // 68: walletrpc.WalletKit.DeriveKey:input_type -> signrpc.KeyLocator
	18, // 69: walletrpc.WalletKit.NextAddr:input_type -> walletrpc.AddrRequest
	29, // 70: walletrpc.WalletKit.GetTransaction:input_type -> walletrpc.GetTransactionRequest
	23, // 71: walletrpc.WalletKit.ListAccounts:input_type -> walletrpc.ListAccountsRequest
	25, // 72: walletrpc.WalletKit.RequiredReserve:input_type -> walletrpc.RequiredReserveRequest
	27, // 73: walletrpc.WalletKit.ListAddresses:input_type -> walletrpc.ListAddressesRequest
	30, // 74: walletrpc.WalletKit.SignMessageWithAddr:input_type -> walletrpc.SignMessageWithAddrRequest
	32, // 75: walletrpc.WalletKit.VerifyMessageWithAddr:input_type -> walletrpc.VerifyMessageWithAddrRequest
	34, // 76: walletrpc.WalletKit.ImportAccount:input_type -> walletrpc.ImportAccountRequest
	36, // 77: walletrpc.WalletKit.ImportPublicKey:input_type -> walletrpc.ImportPublicKeyRequest
	38, // 78: walletrpc.WalletKit.ImportTapscript:input_type -> walletrpc.ImportTapscriptRequest
	43, // 79: walletrpc.WalletKit.PublishTransaction:input_type -> walletrpc.Transaction
	29, // 80: walletrpc.WalletKit.RemoveTransaction:input_type -> walletrpc.GetTransactionRequest
	46, // 81: walletrpc.WalletKit.SendOutputs:input_type -> walletrpc.SendOutputsRequest
	48, // 82: walletrpc.WalletKit.EstimateFee:input_type -> walletrpc.EstimateFeeRequest
	51, // 83: walletrpc.WalletKit.PendingSweeps:input_type -> walletrpc.PendingSweepsRequest
	53, // 84: walletrpc.WalletKit.BumpFee:input_type -> walletrpc.BumpFeeRequest
	55, // 85: walletrpc.WalletKit.BumpForceCloseFee:input_type -> walletrpc.BumpForceCloseFeeRequest
	57, // 86: walletrpc.WalletKit.ListSweeps:input_type -> walletrpc.ListSweepsRequest
	59, // 87: walletrpc.WalletKit.LabelTransaction:input_type -> walletrpc.LabelTransactionRequest
	61, // 88: walletrpc.WalletKit.FundPsbt:input_type -> walletrpc.FundPsbtRequest
	66, // 89: walletrpc.WalletKit.SignPsbt:input_type -> walletrpc.SignPsbtRequest
	68, // 90: walletrpc.WalletKit.FinalizePsbt:input_type -> walletrpc.FinalizePsbtRequest
	4,  // 91: walletrpc.WalletKit.SignCoordinatorStreams:input_type -> walletrpc.SignCoordinatorResponse
	12, // 92: walletrpc.WalletKit.ListUnspent:output_type -> walletrpc.ListUnspentResponse
	14, // 93: walletrpc.WalletKit.LeaseOutput:output_type -> walletrpc.LeaseOutputResponse
	16, // 94: walletrpc.WalletKit.ReleaseOutput:output_type -> walletrpc.ReleaseOutputResponse
	71, // 95: walletrpc.WalletKit.ListLeases:output_type -> walletrpc.ListLeasesResponse
	96, // 96: walletrpc.WalletKit.DeriveNextKey:output_type -> signrpc.KeyDescriptor
	96, // 97: walletrpc.WalletKit.DeriveKey:output_type -> signrpc.KeyDescriptor
	19, // 98: walletrpc.WalletKit.NextAddr:output_type -> walletrpc.AddrResponse
	97, // 99: walletrpc.WalletKit.GetTransaction:output_type -> lnrpc.Transaction
	24, // 100: walletrpc.WalletKit.ListAccounts:output_type -> walletrpc.ListAccountsResponse
	26, // 101: walletrpc.WalletKit.RequiredReserve:output_type -> walletrpc.RequiredReserveResponse
	28, // 102: walletrpc.WalletKit.ListAddresses:output_type -> walletrpc.ListAddressesResponse
	31, // 103: walletrpc.WalletKit.SignMessageWithAddr:output_type -> walletrpc.SignMessageWithAddrResponse
	33, // 104: walletrpc.WalletKit.VerifyMessageWithAddr:output_type -> walletrpc.VerifyMessageWithAddrResponse
	35, // 105: walletrpc.WalletKit.ImportAccount:output_type -> walletrpc.ImportAccountResponse
	37, // 106: walletrpc.WalletKit.ImportPublicKey:output_type -> walletrpc.ImportPublicKeyResponse
	42, // 107: walletrpc.WalletKit.ImportTapscript:output_type -> walletrpc.ImportTapscriptResponse
	44, // 108: walletrpc.WalletKit.PublishTransaction:output_type -> walletrpc.PublishResponse
	45, // 109: walletrpc.WalletKit.RemoveTransaction:output_type -> walletrpc.RemoveTransactionResponse
	47, // 110: walletrpc.WalletKit.SendOutputs:output_type -> walletrpc.SendOutputsResponse
	49, // 111: walletrpc.WalletKit.EstimateFee:output_type -> walletrpc.EstimateFeeResponse
	52, // 112: walletrpc.WalletKit.PendingSweeps:output_type -> walletrpc.PendingSweepsResponse
	54, // 113: walletrpc.WalletKit.BumpFee:output_type -> walletrpc.BumpFeeResponse
	56, // 114: walletrpc.WalletKit.BumpForceCloseFee:output_type -> walletrpc.BumpForceCloseFeeResponse
	58, // 115: walletrpc.WalletKit.ListSweeps:output_type -> walletrpc.ListSweepsResponse
	60, // 116: walletrpc.WalletKit.LabelTransaction:output_type -> walletrpc.LabelTransactionResponse
	62, // 117: walletrpc.WalletKit.FundPsbt:output_type -> walletrpc.FundPsbtResponse
	67, // 118: walletrpc.WalletKit.SignPsbt:output_type -> walletrpc.SignPsbtResponse
	69, // 119: walletrpc.WalletKit.FinalizePsbt:output_type -> walletrpc.FinalizePsbtResponse
	3,  // 120: walletrpc.WalletKit.SignCoordinatorStreams:output_type -> walletrpc.SignCoordinatorRequest
...
func file_walletrpc_walletkit_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_walletrpc_walletkit_proto_msgTypes[68].Exporter = func(v interface{}, i int) interface{} {
		...
		file_walletrpc_walletkit_proto_msgTypes[69].Exporter = func(v interface{}, i int) interface{} {
	...
	file_walletrpc_walletkit_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*SignCoordinatorRequest_MetadataRequest)(nil),
	}
	file_walletrpc_walletkit_proto_msgTypes[1].OneofWrappers = []interface{}{
		...
		(*SignCoordinatorResponse_MetadataReceived)(nil),
	}
	file_walletrpc_walletkit_proto_msgTypes[2].OneofWrappers = []interface{}{
		(*MetadataRequest_LocalCommitmentInfo)(nil),
		(*MetadataRequest_FundingInfo)(nil),
		(*MetadataRequest_Accounts)(nil),
	}
	file_walletrpc_walletkit_proto_msgTypes[6].OneofWrappers = []interface{}{
		(*RegistrationResponse_RegistrationComplete)(nil),
		(*RegistrationResponse_RegistrationError)(nil),
	}
	file_walletrpc_walletkit_proto_msgTypes[7].OneofWrappers = []interface{}{
		(*RegistrationComplete_Accounts)(nil),
	}
	...
	file_walletrpc_walletkit_proto_msgTypes[55].OneofWrappers = []interface{}{
		(*ListSweepsResponse_TransactionDetails)(nil),
		(*ListSweepsResponse_TransactionIds)(nil),
	}
	file_walletrpc_walletkit_proto_msgTypes[58].OneofWrappers = []interface{}{
	...
	file_walletrpc_walletkit_proto_msgTypes[61].OneofWrappers = []interface{}{
