...
type ChannelConfig struct {
	...
	// The channel state bounds.
	ChannelStateBounds *ChannelStateBounds `protobuf:"bytes,1,opt,name=channel_state_bounds,json=channelStateBounds,proto3" json:"channel_state_bounds,omitempty"`
	// The commitment params for the channel.
	CommitmentParams *CommitmentParams `protobuf:"bytes,2,opt,name=commitment_params,json=commitmentParams,proto3" json:"commitment_params,omitempty"`
	// MultiSigKey is the key to be used within the 2-of-2 output script
	// for the owner of this channel config.
	MultiSigKey *KeyDescriptor `protobuf:"bytes,3,opt,name=multi_sig_key,json=multiSigKey,proto3" json:"multi_sig_key,omitempty"`
	// RevocationBasePoint is the base public key to be used when deriving
	// revocation keys for the remote node's commitment transaction. This
	// will be combined along with a per commitment secret to derive a
	// unique revocation key for each state.
	RevocationBasePoint *KeyDescriptor `protobuf:"bytes,4,opt,name=revocation_base_point,json=revocationBasePoint,proto3" json:"revocation_base_point,omitempty"`
	// PaymentBasePoint is the base public key to be used when deriving
	// the key used within the non-delayed pay-to-self output on the
	// commitment transaction for a node. This will be combined with a
	// tweak derived from the per-commitment point to ensure unique keys
	// for each commitment transaction.
	PaymentBasePoint *KeyDescriptor `protobuf:"bytes,5,opt,name=payment_base_point,json=paymentBasePoint,proto3" json:"payment_base_point,omitempty"`
	// DelayBasePoint is the base public key to be used when deriving the
	// key used within the delayed pay-to-self output on the commitment
	// transaction for a node. This will be combined with a tweak derived
	// from the per-commitment point to ensure unique keys for each
	// commitment transaction.
	DelayBasePoint *KeyDescriptor `protobuf:"bytes,6,opt,name=delay_base_point,json=delayBasePoint,proto3" json:"delay_base_point,omitempty"`
	// HtlcBasePoint is the base public key to be used when deriving the
	// local HTLC key. The derived key (combined with the tweak derived
	// from the per-commitment point) is used within the "to self" clause
	// within any HTLC output scripts.
	HtlcBasePoint *KeyDescriptor `protobuf:"bytes,7,opt,name=htlc_base_point,json=htlcBasePoint,proto3" json:"htlc_base_point,omitempty"`
}
...
func (x *ChannelConfig) GetChannelStateBounds() *ChannelStateBounds {
	if x != nil {
		return x.ChannelStateBounds
	}
	return nil
}

func (x *ChannelConfig) GetCommitmentParams() *CommitmentParams {
	if x != nil {
		return x.CommitmentParams
	}
	return nil
}

func (x *ChannelConfig) GetMultiSigKey() *KeyDescriptor {
	if x != nil {
...
func (x *ChannelConfig) GetRevocationBasePoint() *KeyDescriptor {
	if x != nil {
		return x.RevocationBasePoint
	}
	return nil
}

func (x *ChannelConfig) GetPaymentBasePoint() *KeyDescriptor {
	if x != nil {
		return x.PaymentBasePoint
	}
	return nil
}

func (x *ChannelConfig) GetDelayBasePoint() *KeyDescriptor {
	if x != nil {
		return x.DelayBasePoint
	}
	return nil
}

func (x *ChannelConfig) GetHtlcBasePoint() *KeyDescriptor {
	if x != nil {
		return x.HtlcBasePoint
	}
	return nil
}
...
type ChannelStateBounds struct {
	...
	// The minimum satoshis this node is required to reserve in its balance.
	ChanReserveSat uint64 `protobuf:"varint,1,opt,name=chan_reserve_sat,json=chanReserveSat,proto3" json:"chan_reserve_sat,omitempty"`
	// The maximum amount of coins in millisatoshis that can be pending in this
	// channel.
	MaxPendingAmtMsat uint64 `protobuf:"varint,2,opt,name=max_pending_amt_msat,json=maxPendingAmtMsat,proto3" json:"max_pending_amt_msat,omitempty"`
	// The smallest HTLC in millisatoshis that this node will accept.
	MinHtlc uint64 `protobuf:"varint,3,opt,name=min_htlc,json=minHtlc,proto3" json:"min_htlc,omitempty"`
	// The total number of incoming HTLC's that this node will accept.
	MaxAcceptedHtlcs uint32 `protobuf:"varint,4,opt,name=max_accepted_htlcs,json=maxAcceptedHtlcs,proto3" json:"max_accepted_htlcs,omitempty"`
}

func (x *ChannelStateBounds) Reset() {
	*x = ChannelStateBounds{}
	if protoimpl.UnsafeEnabled {
...
func (x *ChannelStateBounds) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChannelStateBounds) ProtoMessage() {}

func (x *ChannelStateBounds) ProtoReflect() protoreflect.Message {
	mi := &file_lightning_proto_msgTypes[202]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChannelStateBounds.ProtoReflect.Descriptor instead.
func (*ChannelStateBounds) Descriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{202}
}

func (x *ChannelStateBounds) GetChanReserveSat() uint64 {
	if x != nil {
		return x.ChanReserveSat
	}
	return 0
...
func (x *ChannelStateBounds) GetMaxPendingAmtMsat() uint64 {
	if x != nil {
		return x.MaxPendingAmtMsat
	}
	return 0
...
func (x *ChannelStateBounds) GetMinHtlc() uint64 {
	if x != nil {
		return x.MinHtlc
	}
	return 0
...
func (x *ChannelStateBounds) GetMaxAcceptedHtlcs() uint32 {
	if x != nil {
		return x.MaxAcceptedHtlcs
	}
	return 0
...
type CommitmentParams struct {
	...
	// The dust limit for this node.
	DustLimit uint64 `protobuf:"varint,1,opt,name=dust_limit,json=dustLimit,proto3" json:"dust_limit,omitempty"`
	// The number of blocks to use for the relative time lock in the pay-to-self
	// output of the commitment transaction.
	CsvDelay uint32 `protobuf:"varint,11,opt,name=csv_delay,json=csvDelay,proto3" json:"csv_delay,omitempty"`
}

func (x *CommitmentParams) Reset() {
	*x = CommitmentParams{}
	if protoimpl.UnsafeEnabled {
...
func (x *CommitmentParams) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CommitmentParams) ProtoMessage() {}

func (x *CommitmentParams) ProtoReflect() protoreflect.Message {
	mi := &file_lightning_proto_msgTypes[203]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CommitmentParams.ProtoReflect.Descriptor instead.
func (*CommitmentParams) Descriptor() ([]byte, []int) {
	return file_lightning_proto_rawDescGZIP(), []int{203}
}

func (x *CommitmentParams) GetDustLimit() uint64 {
	if x != nil {
		return x.DustLimit
	}
	return 0
...
func (x *CommitmentParams) GetCsvDelay() uint32 {
	if x != nil {
		return x.CsvDelay
	}
	return 0
...
var file_lightning_proto_rawDesc = []byte{
	...
	,
...
var file_lightning_proto_goTypes = []interface{}{
	...
	(*ChannelConfig)(nil),                                       // 222: lnrpc.ChannelConfig
	(*ChannelStateBounds)(nil),                                  // 223: lnrpc.ChannelStateBounds
	(*CommitmentParams)(nil),                                    // 224: lnrpc.CommitmentParams
...
var file_lightning_proto_depIdxs = []int32{
	...
	223, // 174: lnrpc.ChannelConfig.channel_state_bounds:type_name -> lnrpc.ChannelStateBounds
	224, // 175: lnrpc.ChannelConfig.commitment_params:type_name -> lnrpc.CommitmentParams
	100, // 176: lnrpc.ChannelConfig.multi_sig_key:type_name -> lnrpc.KeyDescriptor
	100, // 177: lnrpc.ChannelConfig.revocation_base_point:type_name -> lnrpc.KeyDescriptor
	100, // 178: lnrpc.ChannelConfig.payment_base_point:type_name -> lnrpc.KeyDescriptor
	100, // 179: lnrpc.ChannelConfig.delay_base_point:type_name -> lnrpc.KeyDescriptor
	100, // 180: lnrpc.ChannelConfig.htlc_base_point:type_name -> lnrpc.KeyDescriptor
	179, // 181: lnrpc.Peer.FeaturesEntry.value:type_name -> lnrpc.Feature
	179, // 182: lnrpc.GetInfoResponse.FeaturesEntry.value:type_name -> lnrpc.Feature
	...
	231, // 185: lnrpc.PendingChannelsResponse.PendingOpenChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	231, // 186: lnrpc.PendingChannelsResponse.WaitingCloseChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	234, // 187: lnrpc.PendingChannelsResponse.WaitingCloseChannel.commitments:type_name -> lnrpc.PendingChannelsResponse.Commitments
	231, // 188: lnrpc.PendingChannelsResponse.ClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	231, // 189: lnrpc.PendingChannelsResponse.ForceClosedChannel.channel:type_name -> lnrpc.PendingChannelsResponse.PendingChannel
	109, // 190: lnrpc.PendingChannelsResponse.ForceClosedChannel.pending_htlcs:type_name -> lnrpc.PendingHTLC
	...
	114, // 192: lnrpc.WalletBalanceResponse.AccountBalanceEntry.value:type_name -> lnrpc.WalletAccountBalance
	179, // 193: lnrpc.LightningNode.FeaturesEntry.value:type_name -> lnrpc.Feature
	138, // 194: lnrpc.NodeMetricsResponse.BetweennessCentralityEntry.value:type_name -> lnrpc.FloatMetric
	179, // 195: lnrpc.NodeUpdate.FeaturesEntry.value:type_name -> lnrpc.Feature
	179, // 196: lnrpc.Invoice.FeaturesEntry.value:type_name -> lnrpc.Feature
	155, // 197: lnrpc.Invoice.AmpInvoiceStateEntry.value:type_name -> lnrpc.AMPInvoiceState
	179, // 198: lnrpc.PayReq.FeaturesEntry.value:type_name -> lnrpc.Feature
	207, // 199: lnrpc.ListPermissionsResponse.MethodPermissionsEntry.value:type_name -> lnrpc.MacaroonPermissionList
	115, // 200: lnrpc.Lightning.WalletBalance:input_type -> lnrpc.WalletBalanceRequest
	118, // 201: lnrpc.Lightning.ChannelBalance:input_type -> lnrpc.ChannelBalanceRequest
	30,  // 202: lnrpc.Lightning.GetTransactions:input_type -> lnrpc.GetTransactionsRequest
	42,  // 203: lnrpc.Lightning.EstimateFee:input_type -> lnrpc.EstimateFeeRequest
	46,  // 204: lnrpc.Lightning.SendCoins:input_type -> lnrpc.SendCoinsRequest
	48,  // 205: lnrpc.Lightning.ListUnspent:input_type -> lnrpc.ListUnspentRequest
	30,  // 206: lnrpc.Lightning.SubscribeTransactions:input_type -> lnrpc.GetTransactionsRequest
	44,  // 207: lnrpc.Lightning.SendMany:input_type -> lnrpc.SendManyRequest
	50,  // 208: lnrpc.Lightning.NewAddress:input_type -> lnrpc.NewAddressRequest
	52,  // 209: lnrpc.Lightning.SignMessage:input_type -> lnrpc.SignMessageRequest
	54,  // 210: lnrpc.Lightning.VerifyMessage:input_type -> lnrpc.VerifyMessageRequest
	56,  // 211: lnrpc.Lightning.ConnectPeer:input_type -> lnrpc.ConnectPeerRequest
	58,  // 212: lnrpc.Lightning.DisconnectPeer:input_type -> lnrpc.DisconnectPeerRequest
	74,  // 213: lnrpc.Lightning.ListPeers:input_type -> lnrpc.ListPeersRequest
	76,  // 214: lnrpc.Lightning.SubscribePeerEvents:input_type -> lnrpc.PeerEventSubscription
	78,  // 215: lnrpc.Lightning.GetInfo:input_type -> lnrpc.GetInfoRequest
	80,  // 216: lnrpc.Lightning.GetDebugInfo:input_type -> lnrpc.GetDebugInfoRequest
	82,  // 217: lnrpc.Lightning.GetRecoveryInfo:input_type -> lnrpc.GetRecoveryInfoRequest
	110, // 218: lnrpc.Lightning.PendingChannels:input_type -> lnrpc.PendingChannelsRequest
	63,  // 219: lnrpc.Lightning.ListChannels:input_type -> lnrpc.ListChannelsRequest
	112, // 220: lnrpc.Lightning.SubscribeChannelEvents:input_type -> lnrpc.ChannelEventSubscription
	70,  // 221: lnrpc.Lightning.ClosedChannels:input_type -> lnrpc.ClosedChannelsRequest
	97,  // 222: lnrpc.Lightning.OpenChannelSync:input_type -> lnrpc.OpenChannelRequest
	97,  // 223: lnrpc.Lightning.OpenChannel:input_type -> lnrpc.OpenChannelRequest
	94,  // 224: lnrpc.Lightning.BatchOpenChannel:input_type -> lnrpc.BatchOpenChannelRequest
	107, // 225: lnrpc.Lightning.FundingStateStep:input_type -> lnrpc.FundingTransitionMsg
	37,  // 226: lnrpc.Lightning.ChannelAcceptor:input_type -> lnrpc.ChannelAcceptResponse
	89,  // 227: lnrpc.Lightning.CloseChannel:input_type -> lnrpc.CloseChannelRequest
	173, // 228: lnrpc.Lightning.AbandonChannel:input_type -> lnrpc.AbandonChannelRequest
	33,  // 229: lnrpc.Lightning.SendPayment:input_type -> lnrpc.SendRequest
	33,  // 230: lnrpc.Lightning.SendPaymentSync:input_type -> lnrpc.SendRequest
	35,  // 231: lnrpc.Lightning.SendToRoute:input_type -> lnrpc.SendToRouteRequest
	35,  // 232: lnrpc.Lightning.SendToRouteSync:input_type -> lnrpc.SendToRouteRequest
	156, // 233: lnrpc.Lightning.AddInvoice:input_type -> lnrpc.Invoice
	162, // 234: lnrpc.Lightning.ListInvoices:input_type -> lnrpc.ListInvoiceRequest
	161, // 235: lnrpc.Lightning.LookupInvoice:input_type -> lnrpc.PaymentHash
	164, // 236: lnrpc.Lightning.SubscribeInvoices:input_type -> lnrpc.InvoiceSubscription
	177, // 237: lnrpc.Lightning.DecodePayReq:input_type -> lnrpc.PayReqString
	167, // 238: lnrpc.Lightning.ListPayments:input_type -> lnrpc.ListPaymentsRequest
	169, // 239: lnrpc.Lightning.DeletePayment:input_type -> lnrpc.DeletePaymentRequest
	170, // 240: lnrpc.Lightning.DeleteAllPayments:input_type -> lnrpc.DeleteAllPaymentsRequest
	134, // 241: lnrpc.Lightning.DescribeGraph:input_type -> lnrpc.ChannelGraphRequest
	136, // 242: lnrpc.Lightning.GetNodeMetrics:input_type -> lnrpc.NodeMetricsRequest
	139, // 243: lnrpc.Lightning.GetChanInfo:input_type -> lnrpc.ChanInfoRequest
	128, // 244: lnrpc.Lightning.GetNodeInfo:input_type -> lnrpc.NodeInfoRequest
	120, // 245: lnrpc.Lightning.QueryRoutes:input_type -> lnrpc.QueryRoutesRequest
	140, // 246: lnrpc.Lightning.GetNetworkInfo:input_type -> lnrpc.NetworkInfoRequest
	142, // 247: lnrpc.Lightning.StopDaemon:input_type -> lnrpc.StopRequest
	144, // 248: lnrpc.Lightning.SubscribeChannelGraph:input_type -> lnrpc.GraphTopologySubscription
	175, // 249: lnrpc.Lightning.DebugLevel:input_type -> lnrpc.DebugLevelRequest
	180, // 250: lnrpc.Lightning.FeeReport:input_type -> lnrpc.FeeReportRequest
	184, // 251: lnrpc.Lightning.UpdateChannelPolicy:input_type -> lnrpc.PolicyUpdateRequest
	187, // 252: lnrpc.Lightning.ForwardingHistory:input_type -> lnrpc.ForwardingHistoryRequest
	190, // 253: lnrpc.Lightning.ExportChannelBackup:input_type -> lnrpc.ExportChannelBackupRequest
	193, // 254: lnrpc.Lightning.ExportAllChannelBackups:input_type -> lnrpc.ChanBackupExportRequest
	194, // 255: lnrpc.Lightning.VerifyChanBackup:input_type -> lnrpc.ChanBackupSnapshot
	196, // 256: lnrpc.Lightning.RestoreChannelBackups:input_type -> lnrpc.RestoreChanBackupRequest
	198, // 257: lnrpc.Lightning.SubscribeChannelBackups:input_type -> lnrpc.ChannelBackupSubscription
	201, // 258: lnrpc.Lightning.BakeMacaroon:input_type -> lnrpc.BakeMacaroonRequest
	203, // 259: lnrpc.Lightning.ListMacaroonIDs:input_type -> lnrpc.ListMacaroonIDsRequest
	205, // 260: lnrpc.Lightning.DeleteMacaroonID:input_type -> lnrpc.DeleteMacaroonIDRequest
	208, // 261: lnrpc.Lightning.ListPermissions:input_type -> lnrpc.ListPermissionsRequest
	214, // 262: lnrpc.Lightning.CheckMacaroonPermissions:input_type -> lnrpc.CheckMacPermRequest
	219, // 263: lnrpc.Lightning.RegisterRPCMiddleware:input_type -> lnrpc.RPCMiddlewareResponse
	25,  // 264: lnrpc.Lightning.SendCustomMessage:input_type -> lnrpc.SendCustomMessageRequest
	23,  // 265: lnrpc.Lightning.SubscribeCustomMessages:input_type -> lnrpc.SubscribeCustomMessagesRequest
	66,  // 266: lnrpc.Lightning.ListAliases:input_type -> lnrpc.ListAliasesRequest
	21,  // 267: lnrpc.Lightning.LookupHtlcResolution:input_type -> lnrpc.LookupHtlcResolutionRequest
	116, // 268: lnrpc.Lightning.WalletBalance:output_type -> lnrpc.WalletBalanceResponse
	119, // 269: lnrpc.Lightning.ChannelBalance:output_type -> lnrpc.ChannelBalanceResponse
	31,  // 270: lnrpc.Lightning.GetTransactions:output_type -> lnrpc.TransactionDetails
	43,  // 271: lnrpc.Lightning.EstimateFee:output_type -> lnrpc.EstimateFeeResponse
	47,  // 272: lnrpc.Lightning.SendCoins:output_type -> lnrpc.SendCoinsResponse
	49,  // 273: lnrpc.Lightning.ListUnspent:output_type -> lnrpc.ListUnspentResponse
	29,  // 274: lnrpc.Lightning.SubscribeTransactions:output_type -> lnrpc.Transaction
	45,  // 275: lnrpc.Lightning.SendMany:output_type -> lnrpc.SendManyResponse
	51,  // 276: lnrpc.Lightning.NewAddress:output_type -> lnrpc.NewAddressResponse
	53,  // 277: lnrpc.Lightning.SignMessage:output_type -> lnrpc.SignMessageResponse
	55,  // 278: lnrpc.Lightning.VerifyMessage:output_type -> lnrpc.VerifyMessageResponse
	57,  // 279: lnrpc.Lightning.ConnectPeer:output_type -> lnrpc.ConnectPeerResponse
	59,  // 280: lnrpc.Lightning.DisconnectPeer:output_type -> lnrpc.DisconnectPeerResponse
	75,  // 281: lnrpc.Lightning.ListPeers:output_type -> lnrpc.ListPeersResponse
	77,  // 282: lnrpc.Lightning.SubscribePeerEvents:output_type -> lnrpc.PeerEvent
	79,  // 283: lnrpc.Lightning.GetInfo:output_type -> lnrpc.GetInfoResponse
	81,  // 284: lnrpc.Lightning.GetDebugInfo:output_type -> lnrpc.GetDebugInfoResponse
	83,  // 285: lnrpc.Lightning.GetRecoveryInfo:output_type -> lnrpc.GetRecoveryInfoResponse
	111, // 286: lnrpc.Lightning.PendingChannels:output_type -> lnrpc.PendingChannelsResponse
	64,  // 287: lnrpc.Lightning.ListChannels:output_type -> lnrpc.ListChannelsResponse
	113, // 288: lnrpc.Lightning.SubscribeChannelEvents:output_type -> lnrpc.ChannelEventUpdate
	71,  // 289: lnrpc.Lightning.ClosedChannels:output_type -> lnrpc.ClosedChannelsResponse
	38,  // 290: lnrpc.Lightning.OpenChannelSync:output_type -> lnrpc.ChannelPoint
	98,  // 291: lnrpc.Lightning.OpenChannel:output_type -> lnrpc.OpenStatusUpdate
	96,  // 292: lnrpc.Lightning.BatchOpenChannel:output_type -> lnrpc.BatchOpenChannelResponse
	108, // 293: lnrpc.Lightning.FundingStateStep:output_type -> lnrpc.FundingStateStepResp
	36,  // 294: lnrpc.Lightning.ChannelAcceptor:output_type -> lnrpc.ChannelAcceptRequest
	90,  // 295: lnrpc.Lightning.CloseChannel:output_type -> lnrpc.CloseStatusUpdate
	174, // 296: lnrpc.Lightning.AbandonChannel:output_type -> lnrpc.AbandonChannelResponse
	34,  // 297: lnrpc.Lightning.SendPayment:output_type -> lnrpc.SendResponse
	34,  // 298: lnrpc.Lightning.SendPaymentSync:output_type -> lnrpc.SendResponse
	34,  // 299: lnrpc.Lightning.SendToRoute:output_type -> lnrpc.SendResponse
	34,  // 300: lnrpc.Lightning.SendToRouteSync:output_type -> lnrpc.SendResponse
	160, // 301: lnrpc.Lightning.AddInvoice:output_type -> lnrpc.AddInvoiceResponse
	163, // 302: lnrpc.Lightning.ListInvoices:output_type -> lnrpc.ListInvoiceResponse
	156, // 303: lnrpc.Lightning.LookupInvoice:output_type -> lnrpc.Invoice
	156, // 304: lnrpc.Lightning.SubscribeInvoices:output_type -> lnrpc.Invoice
	178, // 305: lnrpc.Lightning.DecodePayReq:output_type -> lnrpc.PayReq
	168, // 306: lnrpc.Lightning.ListPayments:output_type -> lnrpc.ListPaymentsResponse
	171, // 307: lnrpc.Lightning.DeletePayment:output_type -> lnrpc.DeletePaymentResponse
	172, // 308: lnrpc.Lightning.DeleteAllPayments:output_type -> lnrpc.DeleteAllPaymentsResponse
	135, // 309: lnrpc.Lightning.DescribeGraph:output_type -> lnrpc.ChannelGraph
	137, // 310: lnrpc.Lightning.GetNodeMetrics:output_type -> lnrpc.NodeMetricsResponse
	133, // 311: lnrpc.Lightning.GetChanInfo:output_type -> lnrpc.ChannelEdge
	129, // 312: lnrpc.Lightning.GetNodeInfo:output_type -> lnrpc.NodeInfo
	123, // 313: lnrpc.Lightning.QueryRoutes:output_type -> lnrpc.QueryRoutesResponse
	141, // 314: lnrpc.Lightning.GetNetworkInfo:output_type -> lnrpc.NetworkInfo
	143, // 315: lnrpc.Lightning.StopDaemon:output_type -> lnrpc.StopResponse
	145, // 316: lnrpc.Lightning.SubscribeChannelGraph:output_type -> lnrpc.GraphTopologyUpdate
	176, // 317: lnrpc.Lightning.DebugLevel:output_type -> lnrpc.DebugLevelResponse
	182, // 318: lnrpc.Lightning.FeeReport:output_type -> lnrpc.FeeReportResponse
	186, // 319: lnrpc.Lightning.UpdateChannelPolicy:output_type -> lnrpc.PolicyUpdateResponse
	189, // 320: lnrpc.Lightning.ForwardingHistory:output_type -> lnrpc.ForwardingHistoryResponse
	191, // 321: lnrpc.Lightning.ExportChannelBackup:output_type -> lnrpc.ChannelBackup
	194, // 322: lnrpc.Lightning.ExportAllChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	199, // 323: lnrpc.Lightning.VerifyChanBackup:output_type -> lnrpc.VerifyChanBackupResponse
	197, // 324: lnrpc.Lightning.RestoreChannelBackups:output_type -> lnrpc.RestoreBackupResponse
	194, // 325: lnrpc.Lightning.SubscribeChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	202, // 326: lnrpc.Lightning.BakeMacaroon:output_type -> lnrpc.BakeMacaroonResponse
	204, // 327: lnrpc.Lightning.ListMacaroonIDs:output_type -> lnrpc.ListMacaroonIDsResponse
	206, // 328: lnrpc.Lightning.DeleteMacaroonID:output_type -> lnrpc.DeleteMacaroonIDResponse
	209, // 329: lnrpc.Lightning.ListPermissions:output_type -> lnrpc.ListPermissionsResponse
	215, // 330: lnrpc.Lightning.CheckMacaroonPermissions:output_type -> lnrpc.CheckMacPermResponse
	216, // 331: lnrpc.Lightning.RegisterRPCMiddleware:output_type -> lnrpc.RPCMiddlewareRequest
	26,  // 332: lnrpc.Lightning.SendCustomMessage:output_type -> lnrpc.SendCustomMessageResponse
	24,  // 333: lnrpc.Lightning.SubscribeCustomMessages:output_type -> lnrpc.CustomMessage
	67,  // 334: lnrpc.Lightning.ListAliases:output_type -> lnrpc.ListAliasesResponse
	22,  // 335: lnrpc.Lightning.LookupHtlcResolution:output_type -> lnrpc.LookupHtlcResolutionResponse
	268, // [268:336] is the sub-list for method output_type
	200, // [200:268] is the sub-list for method input_type
...
func file_lightning_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_lightning_proto_msgTypes[202].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ChannelStateBounds); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
