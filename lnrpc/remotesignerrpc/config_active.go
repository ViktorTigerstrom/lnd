...
// Config is the primary configuration struct for the RemoteSigner RPC server.
// It contains all the items required for the rpc server to carry out its
...
type Config struct {
	...
	// RemoteSignerDB is the db instance which contains the remote signer
	// whitelists.
