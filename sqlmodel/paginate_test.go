...
func TestExecuteBatchQuery(t *testing.T) {
	...
	t.Run("empty input returns nil", func(t *testing.T) {
		var (
			cfg        = sqldbv2.DefaultSQLiteConfig()
			inputItems []int
		)
...
// query the /REMOVE* SLICE:<field_name>*REMOVE/ directive has a maximum number of
...
func TestSQLSliceQueries(t *testing.T) {
	...
	for {
		...
		if err != nil {
			if db.BackendType == sqldbv2.BackendTypeSqlite {
		...
		if db.BackendType == sqldbv2.BackendTypeSqlite {
			require.LessOrEqual(t, x, sqldbv2.maxSQLiteBatchSize,
				"SQLite should not exceed 32766 parameters")
		} else {
			require.LessOrEqual(t, x, sqldbv2.maxPostgresBatchSize,
...
func TestExecutePaginatedQuery(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			err := sqldbv2.ExecutePaginatedQuery(
...
func TestExecuteCollectAndBatchWithSharedDataQuery(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			err := sqldbv2.ExecuteCollectAndBatchWithSharedDataQuery(
